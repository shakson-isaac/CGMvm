...
from mamba_ssm import Mamba2  # your Mamba2
...
def TFT_train(train_df):
    ...
    first_epoch_timer = FirstEpochTimer(
        ...
        gcs_prefix="checkpoints_mamba2_576"
    )
    # --- GCS checkpoint uploader callback ---
    gcs_ckpt_prefix = "checkpoints_mamba2_576"
...
if __name__ == "__main__":
    ...
    # Save model to GCS
    save_tft_to_gcs(tft, model_name="Mamba2_12h_576c")